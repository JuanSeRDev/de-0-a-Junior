...
{
    alert("Confla, comprate el helado con confites o el pote de 1/4kg");
    alert("y te sobran " + (dineroCofla - 2.9));
}
else {alert("lo siento Cofla, pobre de mierda, no te alcanza para una puta mierda")}
...
else {alert("lo siento Roberto, pobre de mierda, no te alcanza para una puta mierda")}
...
else {alert("lo siento Pedro, pobre de mierda, no te alcanza para una puta mierda")}